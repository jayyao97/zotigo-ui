...
- Source-folder selection can list directory names anywhere accessible to the selected daemon account, matching the authority of source inspection/registration. It does not reveal file contents outside registered roots. Workspace file browsing and editing remain confined to registered sources/workspaces or the session working directory.
